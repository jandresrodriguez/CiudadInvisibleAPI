class PostsController < ApplicationController
  ...
  private
    ...
    def post_params
      params.require(:post).permit(:title, :user_id, :description, :image, :date, :location, :category, assets_attributes: [:id, :post_id, :file])#, assets_images: [:data, :filename, :content_type]) 
